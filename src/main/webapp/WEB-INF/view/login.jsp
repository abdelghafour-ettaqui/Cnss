...
<!-- component -->
<form action="/login/Ulogin" method="Post" class="flex items-center justify-center h-screen">
    <!-- Login Container -->
    <div class="min-w-fit flex-col border bg-white px-6 py-14 shadow-md rounded-[4px] ">
        <div class="mb-8 flex justify-center">
            <img class="w-24" src="https://lobservateur.info/uploads/imported_images/uploads/2017/10/cnss.png" alt="" />
        </div>
        <div class="flex flex-col text-sm rounded-md">
            <input  name="email" class="mb-5 rounded-[4px] border p-3 hover:outline-none focus:outline-none hover:border-yellow-500 " type="text" placeholder="Username or Email id" />
            <input  name="password" class="border rounded-[4px] p-3 hover:outline-none focus:outline-none hover:border-yellow-500" type="password" placeholder="Password" />
        </div>
        <button class="mt-5 w-full border p-2 bg-gradient-to-r from-blue-800 bg-blue-500 text-white rounded-[4px] hover:bg-slate-400 scale-105 duration-300" type="submit">Sign in</button>
        <div class="mt-5 flex justify-between text-sm text-blue-600">
            <a href="#">Forgot password?</a>
            <a href="#">Sign up</a>
        </div>
        <div class="flex justify-center mt-5 text-sm">
            <p class="text-blue-400">or you can sign with</p>
        </div>
        <div class="mt-5 flex justify-center gap-3    ">
            ...
            <a class="bg-blue-400 h-7 w-7 rounded-3xl text-center grayscale cursor-pointer hover:grayscale-0 scale-105 duration-300 " href="">...</a>
        </div>
        <div class="mt-5 flex text-center text-sm text-blue-400">
            <p>
